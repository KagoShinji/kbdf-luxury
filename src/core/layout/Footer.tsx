      ...
      <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-24 flex flex-col items-center text-center">
        ...
        <div className="flex items-center gap-8 mb-12">
          <a
            ...
            className="text-typography-muted hover:text-brand-navy transition-colors"
          ...
          <a
            href="https://www.facebook.com/kbdfluxuryshop"
            target="_blank"
            rel="noopener noreferrer"
            className="text-typography-muted hover:text-brand-navy transition-colors"
            aria-label="Facebook"
          ...
          <a
            href="https://www.tiktok.com/@kbdf.luxury?_r=1&_t=ZS-99pTr0dOBMO"
            target="_blank"
            rel="noopener noreferrer"
            className="text-typography-muted hover:text-brand-navy transition-colors"
            aria-label="TikTok"
